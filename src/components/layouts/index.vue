...
import { menuItems } from "@/utils/dynamicViews";
...
/** 菜单栏选中key */
const selectedKeys = ref<string[]>([currentRouteName.value[0], currentRouteName.value[1]]);
/** 菜单栏点击事件 */
...
<template>
  <a-layout class="main">
    <a-layout-sider class="sider">
      <div class="title"><SlackOutlined spin style="margin-right: 5px; color: #e0392f" />Demo模板</div>
      <a-menu
        id="menu"
